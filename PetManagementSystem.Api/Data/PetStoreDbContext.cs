...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AddressId).HasName("PK__addresse__CAA247C8D9FD2748");
        ...
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__customer__CD65CB855524E004");
            ...
            entity.HasOne(d => d.Address).WithMany(p => p.Customers)
                ...
                .HasConstraintName("FK__customers__addre__71D1E811");
        });

        modelBuilder.Entity<Employee>(entity =>
        {
            entity.HasKey(e => e.EmployeeId).HasName("PK__employee__C52E0BA8B33E59E6");
            ...
            entity.HasOne(d => d.Address).WithMany(p => p.Employees)
                .HasForeignKey(d => d.AddressId)
                .HasConstraintName("FK__employees__addre__4E88ABD4");
            ...
            entity.HasMany(d => d.Pets).WithMany(p => p.Employees)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    r => r.HasOne<Pet>().WithMany()
                        ...
                        .HasConstraintName("FK__employee___pet_i__6B24EA82"),
                    l => l.HasOne<Employee>().WithMany()
                        .HasForeignKey("EmployeeId")
                        .OnDelete(DeleteBehavior.ClientSetNull)
                        .HasConstraintName("FK__employee___emplo__6A30C649"),
                    j =>
                    {
                        j.HasKey("EmployeeId", "PetId").HasName("PK__employee__36BEC7F7FBFC244E");
        ...
        {
            entity.HasKey(e => e.ServiceId).HasName("PK__grooming__3E0DB8AF18294760");
        ...
        {
            entity.HasKey(e => e.PetId).HasName("PK__pets__390CC5FE53523764");
            ...
            entity.HasOne(d => d.Category).WithMany(p => p.Pets)
                ...
                .HasConstraintName("FK__pets__category_i__5812160E");
            ...
            entity.HasMany(d => d.Foods).WithMany(p => p.Pets)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    r => r.HasOne<PetFood>().WithMany()
                        ...
                        .OnDelete(DeleteBehavior.ClientSetNull)
                        .HasConstraintName("FK__pet_food___food___6383C8BA"),
                    l => l.HasOne<Pet>().WithMany()
                        .HasForeignKey("PetId")
                        .OnDelete(DeleteBehavior.ClientSetNull)
                        .HasConstraintName("FK__pet_food___pet_i__628FA481"),
                    j =>
                    {
                        j.HasKey("PetId", "FoodId").HasName("PK__pet_food__ABF80123C7EA1E28");
            ...
            entity.HasMany(d => d.Services).WithMany(p => p.Pets)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    r => r.HasOne<GroomingService>().WithMany()
                        ...
                        .OnDelete(DeleteBehavior.ClientSetNull)
                        .HasConstraintName("FK__pet_groom__servi__6754599E"),
                    l => l.HasOne<Pet>().WithMany()
                        .HasForeignKey("PetId")
                        .OnDelete(DeleteBehavior.ClientSetNull)
                        .HasConstraintName("FK__pet_groom__pet_i__66603565"),
                    j =>
                    {
                        j.HasKey("PetId", "ServiceId").HasName("PK__pet_groo__DAEC1E745EF916A3");
            ...
            entity.HasMany(d => d.Suppliers).WithMany(p => p.Pets)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    r => r.HasOne<Supplier>().WithMany()
                        ...
                        .OnDelete(DeleteBehavior.ClientSetNull)
                        .HasConstraintName("FK__pet_suppl__suppl__6EF57B66"),
                    l => l.HasOne<Pet>().WithMany()
                        .HasForeignKey("PetId")
                        .OnDelete(DeleteBehavior.ClientSetNull)
                        .HasConstraintName("FK__pet_suppl__pet_i__6E01572D"),
                    j =>
                    {
                        j.HasKey("PetId", "SupplierId").HasName("PK__pet_supp__AFE29CB0FC4834E5");
            ...
            entity.HasMany(d => d.Vaccinations).WithMany(p => p.Pets)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    r => r.HasOne<Vaccination>().WithMany()
                        ...
                        .OnDelete(DeleteBehavior.ClientSetNull)
                        .HasConstraintName("FK__pet_vacci__vacci__5FB337D6"),
                    l => l.HasOne<Pet>().WithMany()
                        .HasForeignKey("PetId")
                        .OnDelete(DeleteBehavior.ClientSetNull)
                        .HasConstraintName("FK__pet_vacci__pet_i__5EBF139D"),
                    j =>
                    {
                        j.HasKey("PetId", "VaccinationId").HasName("PK__pet_vacc__57544F003D032A06");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__pet_cate__D54EE9B46A34E238");
        ...
        {
            entity.HasKey(e => e.FoodId).HasName("PK__pet_food__2F4C4DD8251C9600");
        ...
        {
            entity.HasKey(e => e.SupplierId).HasName("PK__supplier__6EE594E89D54A328");
            ...
            entity.HasOne(d => d.Address).WithMany(p => p.Suppliers)
                .HasForeignKey(d => d.AddressId)
                .HasConstraintName("FK__suppliers__addre__5165187F");
        });

        modelBuilder.Entity<Transaction>(entity =>
        {
            entity.HasKey(e => e.TransactionId).HasName("PK__transact__85C600AF704BE74D");
            ...
            entity.HasOne(d => d.Customer).WithMany(p => p.Transactions)
                ...
                .HasConstraintName("FK__transacti__custo__75A278F5");

            entity.HasOne(d => d.Pet).WithMany(p => p.Transactions)
                .HasForeignKey(d => d.PetId)
                .HasConstraintName("FK__transacti__pet_i__76969D2E");
        });

        modelBuilder.Entity<Vaccination>(entity =>
        {
            entity.HasKey(e => e.VaccinationId).HasName("PK__vaccinat__E588AFE791E2CF64");
